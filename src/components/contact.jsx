...
const ContactUs = () => {
  ...
  const ACCESS_KEY = '83ac274f-e862-4df9-ae62-5695bd51a755';
  ...
  const handleSubmit = async (e) => {
    ...
    const submissionData = {
      ...
      subject: 'New Contact Form Submission from Kholiv Consulting Website',
    ...
    try {
      ...
      if (result.success) {
        ...
        toast("Thank you! Your message has been sent successfully. We will get back to you soon.");
